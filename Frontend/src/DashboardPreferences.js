      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto align-items-center">
            ...
            >
              <NavDropdown.Item href="#itinerary" className="d-flex align-items-center">
        ...
        <Row className="g-0 ">
          ...
          <div className="DP-Hero-content ">
            ...
            <div className="btn-div" style={{ display: "flex", justifyContent: "flex-start" }}>
              <button style={{ width: "40%" }} className="overlay-btn"> <a href="#Journey-C"> Lets Get Started </a></button>
            </div>
            </div>
          </Col>
        </Row>
