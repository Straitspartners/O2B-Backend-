...
// const categories = [
//   { id: 10, name: "Natural Beauty And Beaches", img: beaches },
//   { id: 11, name: "Local Cultures & Traditions", img: cultures },
//   { id: 12, name: "Wellness & Relaxation", img: wellness },
//   { id: 13, name: "Wedding & Pre-Wedding", img: wedding },
//   { id: 15, name: "Adventure & Activities", img: adventure },
//   { id: 16, name: "Local Culinary", img: culinary },
//   { id: 17, name: "Shopping In Bali", img: shopping },
//   { id: 18, name: "Luxury & Unique Experiences", img: luxury },
// ];
...
//         `http://192.168.1.8:8000/api/journeys/places-to-visit/?journey_preferences_id=${journeyPreferencesId}`,
//         {
//           headers: {
...
//         "http://192.168.1.8:8000/api/journeys/places-to-visit/",
//         {
...
//         `http://192.168.1.8:8000/api/journeys/journey_preferences/delete/${journeyPreferencesId}/`,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//             "Content-Type": "application/json",
...
//             <button
//               onClick={() => {
//                 if (error === "Journey Preferences ID not found") {
//                   navigate("/signin");
//                 } else {
//                   setError("");
//                 }
      ...
      {error && (
        <div className="popup-overlay">
          <div className="popup">
            ...
            <button
              onClick={() => {
                if (error === "You've reloaded the page or closed the tab. Please start filling preferences again."||error==="Your session has expired . Please sign in again.") {
                  navigate("/signin");
                } else {
                  setError("");
                }
