...
class TravelDetails(models.Model):
    AIRPORT_CHOICES = [
    ('indira_gandhi_international', 'Indira Gandhi International Airport (Delhi)'),
    ('chhatrapati_shivaji_maharaj_international', 'Chhatrapati Shivaji Maharaj International Airport (Mumbai)'),
    ('kempegowda_international', 'Kempegowda International Airport (Bangalore)'),
    ('netaji_subhas_chandra_bose_international', 'Netaji Subhas Chandra Bose International Airport (Kolkata)'),
    ('chennai_international', 'Chennai International Airport (Chennai)'),
    ('rajiv_gandhi_international', 'Rajiv Gandhi International Airport (Hyderabad)'),
    ('sardar_vallabhbhai_patel_international', 'Sardar Vallabhbhai Patel International Airport (Ahmedabad)'),
]
