...
#                     cache.set(cache_key, {"otp": otp, "user_id": user.id}, timeout=300)  # OTP valid for 5 minutes
...
#                     # Check if OTP is already cached (meaning it's been sent already)
#                     cached_data = cache.get(cache_key)
#                     if cached_data:
#                         # OTP already exists, just resend the OTP
#                         send_sms(user.mobile_number, f"Your OTP is: {otp}")
